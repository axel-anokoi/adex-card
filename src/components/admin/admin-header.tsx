    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            style={{
              background: searchOpen 
                ...
                : "transparent",
              border: `1px solid ${searchOpen ? "var(--border-cyan)" : "var(--border)"}`,
          ...
          {searchOpen && (
            <div
              className="dropdown-anim absolute right-0 top-full mt-2 w-72 overflow-hidden rounded-xl p-2"
              style={{
            ...
            >
              <input
                ...
                autoFocus
                className="w-full rounded-lg border border-black/10 bg-black/5 px-3 py-2 text-sm outline-none focus:border-cyan"
                style={{ 
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            style={{
              background: notifOpen 
                ? "color-mix(in srgb, var(--cyan) 10%, transparent)" 
                : "transparent",
              border: `1px solid ${notifOpen ? "var(--border-cyan)" : "var(--border)"}`,
              color: "var(--text-muted)",
            }}
          ...
          {notifOpen && (
            <div
              className="dropdown-anim absolute right-0 top-full mt-2 w-80 overflow-hidden rounded-xl"
              style={{
                background: "color-mix(in srgb, var(--bg2) 95%, transparent)",
                border: "1px solid var(--border)",
                boxShadow: "var(--shadow-xl)",
        ...
        <div className="relative" ref={profileRef}>
          ...
          {profileOpen && (
            <div
              className="dropdown-anim absolute right-0 top-full mt-2 w-56 overflow-hidden rounded-xl"
              style={{
                background: "color-mix(in srgb, var(--bg2) 95%, transparent)",
                border: "1px solid var(--border)",
                boxShadow: "var(--shadow-xl)",
